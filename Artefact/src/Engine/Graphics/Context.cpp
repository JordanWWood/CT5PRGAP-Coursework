...
int Context::InitDirectX() {
	...
	D3D11_INPUT_ELEMENT_DESC vertexLayoutDesc[] = {
		{ "POSITION", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, offsetof(Shader::VertexPosColor,Position), D3D11_INPUT_PER_VERTEX_DATA, 0 },
		{ "COLOR", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, offsetof(Shader::VertexPosColor,Color), D3D11_INPUT_PER_VERTEX_DATA, 0 }
	};
...
#if _DEBUG
	if (!m_shaders->LoadShaders(vertexLayoutDesc, _countof(vertexLayoutDesc), L"SimpleVertexShader_d.cso", L"SimplePixelShader_d.cso")) return -1;
#else
...
Mesh* Context::CreateMesh(const std::vector<Shader::VertexPosColor> vertex, const std::vector<WORD> indices, const DirectX::XMFLOAT3 pPosition, const DirectX::XMFLOAT3 pRotation, const DirectX::XMFLOAT3 pScale) {
